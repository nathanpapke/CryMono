...
namespace CryEngine
{
    public abstract class FlowNode : CryScriptInstance
    {
        ...
        {
            NativeFlowNodeMethods.Instance.RegisterNode(typeName);
        }
        ...
        {
            return NativeFlowNodeMethods.Instance.GetPortValueInt(Handle, GetInputPortId(port.Method));
        }
        ...
        protected T GetPortEnum<T>(Action<T> port) where T : struct
        {
            ...
            return (T)Enum.ToObject(typeof(T), NativeFlowNodeMethods.Instance.GetPortValueInt(Handle, GetInputPortId(port.Method)));
        }
        ...
        {
            return NativeFlowNodeMethods.Instance.GetPortValueFloat(Handle, GetInputPortId(port.Method));
        }
        ...
        {
            return NativeFlowNodeMethods.Instance.GetPortValueVec3(Handle, GetInputPortId(port.Method));
        }
        ...
        {
            return NativeFlowNodeMethods.Instance.GetPortValueString(Handle, GetInputPortId(port.Method));
        }
        ...
        {
            return NativeFlowNodeMethods.Instance.GetPortValueBool(Handle, GetInputPortId(port.Method));
        }
        ...
        {
            return new EntityId(NativeFlowNodeMethods.Instance.GetPortValueEntityId(Handle, GetInputPortId(port.Method)));
        }
        ...
        /// <param name="port"></param>
        /// <returns></returns>
        private bool IsPortActive(int port) { return NativeFlowNodeMethods.Instance.IsPortActive(Handle, port); }
        #endregion
        ...
        public EntityBase TargetEntity
        {
            ...
            {
                uint entId;
                var entPtr = NativeFlowNodeMethods.Instance.GetTargetEntity(Handle, out entId);
