...
{
    interface INativeEntityMethods
    {
        ...
        void RemoveEntity(uint entityId, bool forceRemoveNow = false);
        ...
        void AddMovement(IntPtr animatedCharacterPtr, ref EntityMovementRequest request);
        ...
        bool AddEntityLink(IntPtr entPtr, string linkName, uint otherId, Quat relativeRot, Vec3 relativePos);
        void RemoveEntityLink(IntPtr entPtr, uint otherId);
