...
{
    interface INativeCVarMethods
    {
        void Execute(string command, bool silent);
        void RegisterCommand(string name, string description, CVarFlags flags);

        // CVars
        void RegisterCVarFloat(string name, ref float val, float defaultVal, CVarFlags flags, string description);
        void RegisterCVarInt(string name, ref int val, int defaultVal, CVarFlags flags, string description);
        void RegisterCVarString(string name, string val, string defaultVal, CVarFlags flags, string description);
