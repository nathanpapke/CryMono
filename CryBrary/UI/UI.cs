...
namespace CryEngine
{
    ...
    public class UI
    {
        ...
        {
            var ptr = NativeUIMethods.Instance.CreateEventSystem(name, type);
        ...
        {
            Delegates[eventSystemPtr].Add(NativeUIMethods.Instance.RegisterFunction(eventSystemPtr, name, desc, inputs), methodInfo);
        }
